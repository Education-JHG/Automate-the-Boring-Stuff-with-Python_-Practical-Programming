def printPicnic(itemsDict, leftWidth, rightWidth):
    ...
    for k, v in itemsDict.items():
        ...
        print(k.ljust(leftWidth, '.') + str(v).rjust(rightWidth)) # Aligns each element to its corresponding side. The spaces between will be established in the parameters when the funcion is called.
